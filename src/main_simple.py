"""
NeXOptimIA - Aplicación Principal Simplificada
...
async def dashboard():
    """Dashboard principal de NeXOptimIA"""
    html_content = f"""
    <!DOCTYPE html>
    <html>
    <head>
    ...
    <body>
        ...
        <div style="text-align: center; margin-top: 30px; color: #666;">
            ...
            <p>Desarrollado por OPNeXOX - Jorge Bermúdez Castro</p>
...
async def demo_info():
    ...
    return {
        ...
        "contacto": "Jorge Bermúdez Castro - jorge@nexoptimia.com"
    }
