"""
Dashboard Ejecutivo Visual Avanzado - NeXOptimIA  
...
async def main_selection(request: Request):
    """Pantalla principal de selección de módulos"""
    return templates.TemplateResponse("main_selection.html", {
        "request": request,
        "title": "NexusOptim IA - Selección de Módulo",
        "header": "NexusOptim IA - Selección de Módulo",
        "main_color": "#2ecc40",
        "version": "1.0.0-MVP"
    })
...
async def executive_dashboard(request: Request):
    ...
    return templates.TemplateResponse("executive_dashboard.html", {
        ...
        "company": "NeXOptimIA",
        "main_color": "#2ecc40",
        "header": "App Eléctrica",
        "version": "1.0.0-MVP"
    })

@dashboard_router.get("/tourism", response_class=HTMLResponse)
async def tourism_dashboard(request: Request):
    ...
    tourism_data = {
        ...
        "tours_available": 5,
        "hotels_available": 4,
        "ia_recommendations": "1. Volcán Arenal + Aguas Termales IoT\n   Puntuación IA: 37.1/100\n   Distancia: 130.8 km\n   Precio: $85"
    }
    return templates.TemplateResponse("tourism_dashboard.html", {
        "request": request,
        "data": tourism_data,
        "main_color": "#00e6e6",
        "header": "Smart Tourism Costa Rica",
        "version": "1.0.0-MVP"
    })

@dashboard_router.get("/tutor", response_class=HTMLResponse)
async def tutor_dashboard(request: Request):
    """Dashboard de Tutor Estudiantil"""
    tutor_data = {}
    return templates.TemplateResponse("tutor_dashboard.html", {
        "request": request,
        "data": tutor_data,
        "main_color": "#3a8dde",
        "header": "Maestro Tutor Estudiantil",
        "version": "1.0.0-MVP"
    })

@dashboard_router.get("/water", response_class=HTMLResponse)
async def water_dashboard(request: Request):
    """Dashboard de Agua Inteligente"""
    water_data = {
        "current_consumption": 120,
        "active_sources": 3,
        "alerts": 1
    }
    return templates.TemplateResponse("water_dashboard.html", {
        "request": request,
        "data": water_data,
        "main_color": "#4fc3f7",
        "header": "Gestión Inteligente del Agua",
        "version": "1.0.0-MVP"
    })
...
async def home_dashboard(request: Request):
    ...
    home_data = {
        ...
        "indoor_climate": "22°C, 50% HR"
    }
    return templates.TemplateResponse("home_dashboard.html", {
        "request": request,
        "data": home_data,
        "main_color": "#ffd600",
        "header": "Casa Inteligente",
        "version": "1.0.0-MVP"
    })
...
async def schneider_dashboard(request: Request):
    ...
    schneider_data = {
        ...
        "competitive_landscape": {
            ...
            "nexoptimia_advantage": { # TODO: revisar si la clave debe cambiar en toda la app
