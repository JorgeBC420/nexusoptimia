...
NexusOptim IA - Optimizada para hosting web público
"""
...
async def dashboard():
    ...
    <head>
        ...
        <meta name="author" content="Jorge Bermúdez Castro - OpenNexus">
        
        <!-- Open Graph / Facebook -->
        <meta property="og:type" content="website">
        <meta property="og:url" content="{PUBLIC_URL}">
        <meta property="og:title" content="NexusOptim IA - Smart Cities Costa Rica">
    ...
    <body>
        ...
        <div class="footer">
            <div class="container">
                <p><strong>NexusOptim IA</strong> - Desarrollado por OpenNexus</p>
...
async def demo_info():
    ...
    return {
        "titulo": "NexusOptim IA - Demos Disponibles",
