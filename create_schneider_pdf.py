...
def create_schneider_pdf_reportlab():
    ...
    filename = "NexusOptim_IA_Schneider_Electric_Partnership.pdf"
    ...
    # Página de título
    story.append(Paragraph("🏢 NexusOptim IA", title_style))
    ...
    story.append(Paragraph(
        "NexusOptim IA is a comprehensive Edge AI platform designed to optimize critical infrastructure "
    ...
    contact_data = [
        ...
        ['Position', 'Founder & CEO - OpenNexus'],
    ...
    story.append(Spacer(1, 0.5*inch))
    story.append(Paragraph("© 2025 OpenNexus - NexusOptim IA", 
