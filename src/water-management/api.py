...
async def get_realtime_electrical_consumption():
    ...
    try:
        ...
        # Enriquecer con métricas adicionales de NeXOptimIA
        enhanced_data = {
            **consumption_data,
            "nexoptimia_analysis": {
...
async def get_competitive_analysis():
    """Análisis competitivo NeXOptimIA vs. Genie (California) y contexto global"""
    try:
        ...
        return {
            ...
            "comparison": "NeXOptimIA vs Genie (California)",
            "data": analysis,
            "summary": {
                "nexoptimia_advantages": [ # TODO: revisar si la clave debe cambiar en toda la app
...
async def get_ice_2025_official_analysis():
    ...
    try:
        ...
        # Enriquecer con integración NeXOptimIA
        enhanced_analysis = {
            **analysis,
            "nexoptimia_integration": { # TODO: revisar si la clave debe cambiar en toda la app
...
async def get_ice_2025_dashboard():
    ...
    try:
        ...
        <head>
            ...
            <title>ICE 2025 - Análisis Predictivo Oficial | NeXOptimIA</title>
        ...
        <body>
            ...
            <div class="metrics-grid">
                ...
                <div class="metric-card">
                    <div class="metric-label">ROI NeXOptimIA</div>
                    <div class="metric-value highlight">{analysis['nexoptimia_recommendations']['roi_projections']['payback_period']}</div> # TODO: revisar si la clave debe cambiar en toda la app
            ...
            <div class="analysis-section recommendations">
                <div class="section-title">🚀 Recomendaciones NeXOptimIA</div>
                <div class="rec-item">
                    <strong>🎯 Fase 1 (Q3 2025):</strong> Despliegue IoT en 15 subestaciones principales + ML para predicción demanda industrial
                </div>
                <div class="rec-item">
                    <strong>⚡ Optimización Inmediata:</strong> {analysis['nexoptimia_recommendations']['ai_optimization_opportunities']['demand_forecasting']['accuracy_improvement']} mejora precisión pronóstico # TODO: revisar si la clave debe cambiar en toda la app
                </div>
                <div class="rec-item">
                    <strong>💰 Impacto Económico:</strong> ₡450M ahorro primer año + ROI en {analysis['nexoptimia_recommendations']['roi_projections']['payback_period']} # TODO: revisar si la clave debe cambiar en toda la app
                </div>
                <div class="rec-item">
                    <strong>🌱 Integración EV:</strong> Smart charging + V2G con {analysis['nexoptimia_recommendations']['ai_optimization_opportunities']['ev_integration']['v2g_potential']} capacidad bidireccional # TODO: revisar si la clave debe cambiar en toda la app
                </div>
                <div class="rec-item">
                    <strong>🛡️ Grid Modernization:</strong> {analysis['nexoptimia_recommendations']['ai_optimization_opportunities']['grid_stability']['outage_prevention']} reducción interrupciones no programadas # TODO: revisar si la clave debe cambiar en toda la app
                </div>
            </div>
            ...
            <div class="footer">
                ...
                <p><strong>🤖 Powered by:</strong> NeXOptimIA × Schneider Electric Partnership</p>
                <p>📧 Contacto: jorge@nexoptimia.com | 🌐 nexoptimia.com</p>
            </div>
        </body>
        </html>
        """
